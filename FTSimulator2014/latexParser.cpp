...
void CPARSER::generatesPDF(std::string path){
	...
	std::string caminho1 = "pdflatex  -include-directory=" + path + "/output/ -output-directory=" + path + "/output input_fft_absolute.tex ";
	std::string caminho2 = "pdflatex -include-directory=" + path + "/output/ -output-directory=" + path +"/output input_fft_phase.tex";
	std::string caminho3 = "pdflatex -include-directory=" + path + "/output/ -output-directory=" + path + "/output output_fft_absolute.tex";
	std::string caminho4 = "pdflatex -include-directory=" + path + "/output/ -output-directory=" + path + "/output output_fft_phase.tex";
